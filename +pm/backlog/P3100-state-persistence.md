...
- [ ] `commands` table created via migration
- [ ] `pipelines` table created via migration
- [ ] `event_log` table created via migration
- [ ] All op executions journaled
- [ ] All system events logged to event_log
- [ ] Startup recovery marks orphaned commands
- [ ] Log rotation runs daily (configurable retention)
- [ ] Test: restart dashboard mid-command, verify recovery
