...
- [x] Pipeline struct matches CORE-002 spec
- [x] Built-in pipelines registered at startup (4 pipelines)
- [x] && semantics work (failed hosts excluded)
- [x] Pipeline status tracked (RUNNING, PARTIAL, COMPLETE, FAILED, CANCELLED)
- [x] `/api/dispatch/pipeline` endpoint works
- [x] `/api/pipelines` endpoint lists all pipelines
